						...
						<div className="space-y-4">
							...
							>
								{avatar ? (
									...
									<div className="flex h-32 w-32 items-center justify-center rounded-full border-2 border-gray-300 border-dashed bg-gray-50 hover:bg-gray-100">
										<div className="text-center">
						...
						<div className="space-y-4">
							...
							>
								{header ? (
									...
									<div
										className="flex h-32 w-64 items-center justify-center rounded-lg border-2 border-gray-300 border-dashed hover:bg-gray-100"
										style={{
											background:
