    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          {/* Header Image */}
          <div
            className="h-48 w-full relative overflow-hidden rounded-t-sm"
            style={{
      ...
      {/* Profile Content Sections - Matching /me page layout */}
      <div className="mt-6 space-y-6">
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <ENSFieldDisplay
              ensName={ensName}
              field={{ key: "url", label: "Website", isUrl: true }}
            />

            <ENSFieldDisplay
              ensName={ensName}
              field={{ key: "email", label: "Email", isEmail: true }}
            />
          </div>
        </div>
