...
export function ENSGalleryField({
  ...
  return (
    <div className="space-y-4 rounded-lg border border-gray-200 p-4">
      ...
      >
        {!value ? (
          <div className="flex h-24 w-full items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100">
          ...
          <div className="flex h-12 w-full items-center justify-center rounded-lg bg-gray-50 hover:bg-gray-100">
